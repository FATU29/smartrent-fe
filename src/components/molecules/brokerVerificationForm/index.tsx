...
const BrokerVerificationForm: React.FC<BrokerVerificationFormProps> = ({
  ...
  const rejectionReason = brokerStatusQuery.data?.brokerRejectionReason?.trim()
  const certUrl =
            ...
            <AlertDescription>
              ...
              {currentStatus === 'REJECTED' && (
                <div className='space-y-3'>
                  ...
                  {rejectionReason && (
                    <div className='flex items-start gap-2 rounded-lg border border-amber-300/90 bg-amber-50/90 px-3 py-2.5 shadow-sm dark:border-amber-700/70 dark:bg-amber-950/40'>
